...
\program{Curso de Engenharia Eletrônica}
...
\author{Marcelo Fernandes de Morais Filho}  % Seu nome
\authorbib{Filho, Marcelo Fernandes de Morais} % Seu nome para referência bibliográfica (Sobrenome, Nome)
\title{Processador de Áudio e Otimizador de Fones de Ouvido Independente} % Título do trabalho
\titleen{Independent Audio Processor and Headphone Optimizer} % Título traduzido para inglês
\advisor{Prof. Rafael Eleodoro de Góes} % Nome do orientador. Lembre-se de prefixar com "Prof. Dr.", "Profª. Drª.", "Prof. Me." ou "Profª. Me."}
...
\PalavraChaveA{Otimiza{\c{c}}{\~a}o sonora}%% Palavra-chave A
\PalavraChaveB{Processamento Digital de Sinais}%% Palavra-chave B
\PalavraChaveC{Fones de Ouvido}%% Palavra-chave C
\PalavraChaveD{Convers{\~a}o digital-anal{\'o}gica}%% Palavra-chave D
\PalavraChaveE{{\'A}udio USB}%% Palavra-chave E
...
\KeywordA{Sound optimization}%% Keyword A
\KeywordB{Digital Signal Processing}%% Keyword B
\KeywordC{Headphones}%% Keyword C
\KeywordD{Digital to Analog Conversion}%% Keyword D
\KeywordE{USB Audio}%% Keyword E
